    ...
    <div className="min-h-screen bg-brand-paper pt-24 md:pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <span className="inline-block text-[10px] uppercase tracking-[0.5em] font-bold text-brand-gold mb-6">Professional</span>
          ...
          <p className="text-brand-ink/60 font-light leading-relaxed">
            Fill out the form below to apply for the Professional membership tier (€80/year). Join a network of entrepreneurs, academics, and creatives.
          </p>
        </motion.div>
        ...
        <form className="bg-white rounded-[32px] p-8 md:p-12 border border-brand-ink/5 shadow-sm space-y-8" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-brand-ink/60">Company / Organization (Optional)</label>
              <input type="text" className="w-full bg-brand-paper border border-brand-ink/10 rounded-xl px-4 py-3 text-brand-ink focus:outline-none focus:border-brand-gold focus:ring-1 focus:ring-brand-gold transition-all" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-brand-ink/60">Job Title / Profession</label>
              <input type="text" className="w-full bg-brand-paper border border-brand-ink/10 rounded-xl px-4 py-3 text-brand-ink focus:outline-none focus:border-brand-gold focus:ring-1 focus:ring-brand-gold transition-all" required />
            </div>
          </div>
          <div className="space-y-2">
            <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-brand-ink/60">LinkedIn Profile (Optional)</label>
          ...
          <div className="space-y-2">
            <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-brand-ink/60">Brief Professional Background</label>

...
export default function Impact() {
  ...
  return (
    <div className="pt-20 bg-brand-paper text-slate-900 min-h-screen">
      ...
      {/* Executive Hero */}
      <section className="relative min-h-[35vh] md:h-[50vh] flex items-center px-6 bg-[#0A1128] text-white overflow-hidden border-b border-brand-gold/20">
